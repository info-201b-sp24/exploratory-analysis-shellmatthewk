...
I summarized 8 quantifiable variables from the data set. Firstly, I found the number of observations in this data set to be 736, which is a considerable amount, but maybe not substantial enough. Secondly, I found the average age of all people in the data set to be around 25.2, which is most likely higher than our average age in the class, but still somewhat close. One thing to note about this variable is that the difference between our brains and the average in the data set is that our brains are still not fully developed, in comparison to the ones in the data set. 

Next, I found the average hours listened per person per day, which was around 3.57. This number doesn't surprise me, as people are most likely listening to music at home or while using transportation, or even working. I calculated the most common streaming platform to be Spotify, at 458 instances out of the total 736. Spotify is one of the most popular music streaming platforms to us, so it makes sense that Spotify is the most common by over 50% of the collected population. 

The last 4 variables are all similar to each other. I found the average scores (0-10 and 10 being the highest) of anxiety, depression, insomnia and OCD from the people that were surveyed. Anxiety started at 5.84, depression at 4.80, insomnia at 3.74, and OCD at 2.64. I cannot make any statements on these variables and why they might be higher, but one thing to be noted is that anxiety and depression are significantly higher than OCD. 

### Table

Table sorted by average hours listened per day, and the frequencies of each genre of music, and mental health score according to that amount of hours listened per day. 
